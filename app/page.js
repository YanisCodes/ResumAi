...
export default function Home() {
  const [mode, setMode] = useState("scratch"); // "scratch" | "tailor"
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "2.5rem 1.5rem", position: "relative" }}>
        ...
        <div style={{ background: "white", borderRadius: 24, boxShadow: "0 30px 80px rgba(0,0,0,0.3)", overflow: "hidden" }}>
          ...
          <div style={{ padding: "2.5rem" }}>
            ...
            {/* Job Description field — only in tailor mode, shown first */}
            {mode === "tailor" && (
              <div style={{ marginBottom: "2rem" }}>
                <div style={{
                  ...
                  <textarea
                    ...
                    placeholder="Paste the full job or internship description here... AI will tailor your CV to match the required skills, keywords, and tone."
                    rows={5}
                    style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "2rem" }}>
              {[
                { name: "objectif", label: "Professional Objective", placeholder: "Ex: Seeking an internship in web development to apply my skills...", rows: 2 },
                { name: "experiences", label: "Experiences & Projects", placeholder: "Ex: E-commerce project in Next.js (2024)\nWeb dev internship - Summer 2024\nMember of ESTIN CS club", rows: 3 },
            ...
            <button onClick={generateCV} disabled={loading} className="generate-btn" style={{
              ...
              {loading ? "⏳ Generating your CV..."
                : mode === "tailor" ? "🎯 Generate tailored CV"
                : "✨ Generate my CV"}
            </button>
